...
$result = $connection->query("select UUID from servicios where UUID='".$IdUsr."';");
$outp = "";
...
if($IdUsr==$outp){
	...
	$result = $connection->query("UPDATE servicios SET ESTATUS=".$newestatus."  WHERE UUID='".$IdUsr."' AND ESTATUS=".$edo.";");	
