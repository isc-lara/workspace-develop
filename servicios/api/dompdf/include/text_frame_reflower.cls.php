...
//     pre_r("Offset: " . $offset);
  ...
  function get_min_max_width() {
    ...
    case "pre-line":
      ...
      array_walk($words, create_function('&$val,$str', '$val = Font_Metrics::get_text_width($str, "'.$font.'", '.$size.', '.$spacing.');'));
      arsort($words);
      $min = reset($words);
      break;
    ...
    case "pre":
      ...
      array_walk($lines, create_function('&$val,$str','$val = Font_Metrics::get_text_width($str, "'.$font.'", '.$size.', '.$spacing.');'));
